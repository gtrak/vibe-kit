...
it will work the same way tomorrow as it did today.  It's better to have the LLM write the code to do the task than it is to depend upon the LLM directly
doing the task, especially if it needs to be done often.
